...
from cursoresource.models.hotel import HotelModel
from cursoresource.models.site import SiteModel
from cursoresource.resources.filtros import normalize_path_params, consulta_com_cidade, consulta_sem_cidade
